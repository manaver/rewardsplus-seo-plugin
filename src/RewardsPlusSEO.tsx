// src/RewardsPlusSEO.tsx
import type { Metadata } from 'next';
import { RewardsPlusSEOProps } from './types'; // Import from types.ts

const schemaUrl = (path: string) => `https://schema.org/${path}`;

export function generateRewardsPlusMetadata(props: RewardsPlusSEOProps): Metadata {
    const {
        pageType,
        title,
        description,
